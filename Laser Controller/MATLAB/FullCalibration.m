...
% Grid of points ----------------------------------------------------
% Points to move
points_Ma = 20; % How many points on the grid for Ma
points_Mb = 20; % How many points on the grid for Mb
...
% Random permutes the elements
ix = randperm(length(Ms));
Ms = Ms(ix, :);
...
G_P  = [190, 210, G_z2];    % Where the laser is attached
